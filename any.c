...
struct anytree_functions * get_bstree_functions(void)
{
    ...
    {
        inited = 1;
        bstree_functions.first_fn = (anytree_first_fn_t)avltree_first;
        bstree_functions.last_fn  = (anytree_last_fn_t)avltree_last;
        bstree_functions.next_fn  = (anytree_next_fn_t)avltree_next;
        bstree_functions.prev_fn  = (anytree_prev_fn_t)avltree_prev;
        bstree_functions.lookup_fn  = (anytree_lookup_fn_t)avltree_lookup;
        bstree_functions.insert_fn  = (anytree_insert_fn_t)avltree_insert;
        bstree_functions.remove_fn  = (anytree_remove_fn_t)avltree_remove;
        bstree_functions.replace_fn = (anytree_replace_fn_t)avltree_replace;
    }
...
struct anytree_functions * get_rbtree_functions(void)
{
    ...
    {
        inited = 1;
        rbtree_functions.first_fn = (anytree_first_fn_t)avltree_first;
        rbtree_functions.last_fn  = (anytree_last_fn_t)avltree_last;
        rbtree_functions.next_fn  = (anytree_next_fn_t)avltree_next;
        rbtree_functions.prev_fn  = (anytree_prev_fn_t)avltree_prev;
        rbtree_functions.lookup_fn  = (anytree_lookup_fn_t)avltree_lookup;
        rbtree_functions.insert_fn  = (anytree_insert_fn_t)avltree_insert;
        rbtree_functions.remove_fn  = (anytree_remove_fn_t)avltree_remove;
        rbtree_functions.replace_fn = (anytree_replace_fn_t)avltree_replace;
    }
...
struct anytree_functions * get_splaytree_functions(void)
{
    ...
    {
        inited = 1;
        splaytree_functions.first_fn = (anytree_first_fn_t)avltree_first;
        splaytree_functions.last_fn  = (anytree_last_fn_t)avltree_last;
        splaytree_functions.next_fn  = (anytree_next_fn_t)avltree_next;
        splaytree_functions.prev_fn  = (anytree_prev_fn_t)avltree_prev;
        splaytree_functions.lookup_fn  = (anytree_lookup_fn_t)avltree_lookup;
        splaytree_functions.insert_fn  = (anytree_insert_fn_t)avltree_insert;
        splaytree_functions.remove_fn  = (anytree_remove_fn_t)avltree_remove;
        splaytree_functions.replace_fn = (anytree_replace_fn_t)avltree_replace;
    }
    return &splaytree_functions;
}

struct anytree_functions bstree_functions;
struct anytree_functions rbtree_functions;
struct anytree_functions splaytree_functions;

struct anytree * anytree_init(enum anytree_type type, anytree_cmp_fn_t cmp)
{
    struct anytree *tree = (struct anytree *)malloc(sizeof(struct anytree));
    switch (type)
    {
    case ANYTREE_AVL:
